...
namespace IMS.Tests.InputIncident10
{
    public class InputIncident10
    {
        ...
        [Test]
        public void TestInputIncident10()
        {
            test = extent.StartTest("Редактирование полей Инцидента");
            ...
            incidentPage.FindAndChooseIncident(); 





            incidentPage.ChangeNumberOfIncidentInput();
