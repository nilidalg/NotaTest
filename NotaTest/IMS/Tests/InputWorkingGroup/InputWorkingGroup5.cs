...
namespace IMS.Tests.InputWorkingGroup5
{
    public class InputWorkingGroup5
    {
        ...
        [Test]
        public void TestInputWorkingGroup5()
        {
            ...
            workingGroup.ChangeShortDescriptionOfGroupInput();
