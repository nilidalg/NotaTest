...
namespace IMS.Tests.InputWorkingGroup11
{
    public class InputWorkingGroup11
    {
        ...
        [Test]
        public void TestInputWorkingGroup11()
        {
