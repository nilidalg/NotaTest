...
namespace IMS.Tests.Task1_32
{
    public class Task1_32
    {
        ...
        [Test]
        public void TestTask1_32()
        {
            test = extent.StartTest("Создание подзадачи в разделе \"Мои задачи\"");
            ...
            incidentPage.TaskPageActionButton();
            incidentPage.CreateTaskInActionBar();
