...
namespace IMS.Tests.Task1_47
{
    public class Task1_47
    {
        ...
        [Test]
        public void TestTask1_47()
        {
            test = extent.StartTest("Возобновление задачи в разделе 'Список задач'");
            ...
            */
            ...
            incidentPage.DescriptionOfTask();
            incidentPage.StatusOfTask();
