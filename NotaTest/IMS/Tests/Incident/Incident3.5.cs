...
namespace IMS.Tests.Incident3_5
{
    public class Incident3_5
    {
        ...
        [Test]
        public void TestIncident3_5()
        {
            test = extent.StartTest("Создание инцидента федерального уровня");
            goTo.LoginPage(ConfigurationManager.AppSettings["LoginPage"]);
            loginObjects.InputLoginDoer(ConfigurationManager.AppSettings["LoginDoer"]);
            loginObjects.InputPwdDoer(ConfigurationManager.AppSettings["PwdDoer"]);
