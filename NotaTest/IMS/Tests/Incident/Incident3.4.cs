...
namespace IMS.Tests.Incident3_4
{
    public class Incident3_4
    {
        ...
        [Test]
        public void TestIncident3_4()
        {
            test = extent.StartTest("Создание инцидента федерального уровня");
            goTo.LoginPage(ConfigurationManager.AppSettings["LoginPage"]);
            loginObjects.InputLoginOwner(ConfigurationManager.AppSettings["LoginOwner"]);
            loginObjects.InputPwdOwner(ConfigurationManager.AppSettings["PwdOwner"]);
